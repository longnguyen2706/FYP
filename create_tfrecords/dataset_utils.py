...
def _get_filenames_and_classes(dataset_dir):
  ...
  print("photo_filenames", photo_filenames)
      ...
      for shard_id in range(_NUM_SHARDS):
        ...
        with tf.python_io.TFRecordWriter(output_filename) as tfrecord_writer:
          ...
          for i in range(start_ndx, end_ndx):
            ...
            # Read the filename:
            image_data = tf.gfile.FastGFile(filenames[i], 'rb').read() #changed 'r' to 'rb' for python3
            ...
            example = image_to_tfexample(
                image_data, 'jpg'.encode(), height, width, class_id)#changed 'jpg' to 'jpg'.encode() for python3
