...
hidden_layer1_size_arr=(50 100 150)  # set the minibatch size
dropout_keep_prob_arr=(0.7 0.8) # set numnber of neuron in the hidden layer
learning_rate_decay_arr=(0.33 0.50 0.66) #(0.33 0.5 0.66) #0.66 # set the keep prob of the dropout
