...
def get_checkpoint_path(step, training_fold_names):
    ...
    checkpoint_name = "model_" + "step_" + str(step) + "_folds_"+str(fold_indexs)+  "_lr_" + str(FLAGS.learning_rate) + "_test_p_" + str(
                ...
                if (i % FLAGS.eval_step_interval) == 0 or is_last_step:
                    ...
                    if is_final_train:
                        train_accuracy_two_decimal, validation_accuracy_two_decimal = train_validation_two_decimal(
                            train_accuracy, 0)
                        intermediate_result = ['', datetime.now(), i, train_accuracy * 100,'',
                                               training_fold_names]
