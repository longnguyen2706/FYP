...
csv_log_directory = '/home/duclong002/retrain_logs/logfile/' + "test_" + "ensemble_4_" + "PAP_" + str(datetime.now()).replace(" ", "-") + ".csv"
...
summaries_directory = '/home/duclong002/retrain_logs/ensemble/' + "test_" + "ensemble_4_" + "PAP_" + str(datetime.now()).replace(" ", "-") + ".csv"
...
GENERAL_SETTING = {
    ...
    'image_dir': '/home/duclong002/Dataset/JPEG_data/PAP_smear_JPEG/', # !Important: set the dataset directory
...
#     # },
#     {
#         'architecture': ['resnet_v2', 'inception_v3'], # feature concat model
