...
def add_final_training_ops(class_count, final_tensor_name, bottleneck_tensor,
                           bottleneck_tensor_size, hidden_layer1_size):
...
def create_model_info(architecture):
    ...
    elif architecture == 'inception-resnet_v2':
        bottleneck_tensor_name = 'InceptionResnetV2/Logits/Flatten/Reshape:0'
        bottleneck_tensor_size = 1536
        input_width = 299
        input_height = 299
        input_depth = 3
        resized_input_tensor_name = 'InceptionResnetV2/Conv2d_1a_3x3:0'
        model_file_name = 'inception-resnet_output.pb'
        input_mean = 128
        input_std = 128
 ...
 # Add the new layer that we'll be training.
        (train_step, cross_entropy, bottleneck_input, ground_truth_input,
         final_tensor, keep_prob) = add_final_training_ops(
            ...
            model_info['bottleneck_tensor_size'], FLAGS.hidden_layer1_size)
        ...
        for i in range(FLAGS.how_many_training_steps):
            ...
            train_summary, _ = sess.run(
                ...
                feed_dict={bottleneck_input: train_bottlenecks,
                           ground_truth_input: train_ground_truth, keep_prob: FLAGS.dropout_keep_prob})
